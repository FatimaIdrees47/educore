...
<head>
    ...
    <title>@yield('title', 'Dashboard') — EduCore Super Admin</title>
...
<body>
    ...
    <aside class="educore-sidebar sidebar-super-admin">
        ...
        <nav class="py-2">
            ...
            <a href="{{ route('super-admin.dashboard') }}"
                class="sidebar-nav-item {{ request()->routeIs('super-admin.dashboard') ? 'active' : '' }}">
            ...
            <a href="{{ route('super-admin.schools.index') }}"
                class="sidebar-nav-item {{ request()->routeIs('super-admin.schools*') ? 'active' : '' }}">
                <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <a href="{{ route('super-admin.settings') }}"
                class="sidebar-nav-item {{ request()->routeIs('super-admin.settings*') ? 'active' : '' }}">
                <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="topbar-actions">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li><span class="dropdown-item-text text-muted" style="font-size:12px">Super Admin</span></li>
                    <li>
